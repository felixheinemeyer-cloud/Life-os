...
interface TimeWealthQuestion1ContentProps {
  answer: string;
...
const TimeWealthQuestion1Content: React.FC<TimeWealthQuestion1ContentProps> = ({
  answer,
  onAnswerChange,
  onContinue,
  buttonText = 'Continue',
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              What are your best self's 2-3 biggest priorities in life?
            </Text>
          </View>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Think about what truly matters most to you. These are the North Stars that should guide how you spend your time and energy.
            </Text>
          </View>
        </ScrollView>
...
export default TimeWealthQuestion1Content;
