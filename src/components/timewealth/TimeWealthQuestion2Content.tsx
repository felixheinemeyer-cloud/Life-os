...
interface TimeWealthQuestion2ContentProps {
  answer: string;
...
const TimeWealthQuestion2Content: React.FC<TimeWealthQuestion2ContentProps> = ({
  answer,
  onAnswerChange,
  onContinue,
  buttonText = 'Continue',
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              How does your best self spend their time across different seasons of life?
            </Text>
          </View>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Consider different life phases: career building, raising family, retirement. How do priorities and time allocation shift across these seasons?
            </Text>
          </View>
        </ScrollView>
...
export default TimeWealthQuestion2Content;
