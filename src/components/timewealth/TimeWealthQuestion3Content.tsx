...
interface TimeWealthQuestion3ContentProps {
  answer: string;
...
const TimeWealthQuestion3Content: React.FC<TimeWealthQuestion3ContentProps> = ({
  answer,
  onAnswerChange,
  onContinue,
  buttonText = 'Continue',
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              If you were living as your best self, how would you spend your time on a typical day and week?
            </Text>
          </View>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Envision your ideal routine. What activities fill your mornings, afternoons, and evenings? How do you balance work, relationships, growth, and rest?
            </Text>
          </View>
        </ScrollView>
...
export default TimeWealthQuestion3Content;
