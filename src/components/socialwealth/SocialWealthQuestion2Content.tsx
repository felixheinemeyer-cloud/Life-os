...
interface SocialWealthQuestion2ContentProps {
  answer: string;
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              How does your best self show up in a romantic relationship to build and maintain that connection?
            </Text>
          </View>
...
export default SocialWealthQuestion2Content;
