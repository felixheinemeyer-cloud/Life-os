...
interface SocialWealthQuestion1ContentProps {
  answer: string;
...
const SocialWealthQuestion1Content: React.FC<SocialWealthQuestion1ContentProps> = ({
  answer,
  onAnswerChange,
  onContinue,
  buttonText = 'Continue',
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              What does your best self's ideal romantic relationship look and feel like?
            </Text>
          </View>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Think about how you communicate, show love, handle conflicts, and create moments of connection with your partner.
            </Text>
          </View>
        </ScrollView>
...
export default SocialWealthQuestion1Content;
