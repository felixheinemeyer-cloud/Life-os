...
interface MentalWealthQuestion2ContentProps {
  answer: string;
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              How does your best self think, make decisions, and respond to challenges?
            </Text>
          </View>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Consider your decision-making process, problem-solving approach, and how you handle uncertainty and adversity.
            </Text>
          </View>
        </ScrollView>
...
export default MentalWealthQuestion2Content;
