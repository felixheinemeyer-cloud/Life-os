...
interface MentalWealthQuestion1ContentProps {
  answer: string;
...
const MentalWealthQuestion1Content: React.FC<MentalWealthQuestion1ContentProps> = ({
  answer,
  onAnswerChange,
  onContinue,
  buttonText = 'Continue',
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              What does your inner world look and feel like when you are living as your best mental self?
            </Text>
          </View>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Think about your mental clarity, emotional resilience, focus, and how you handle stress and challenges.
            </Text>
          </View>
        </ScrollView>
...
export default MentalWealthQuestion1Content;
