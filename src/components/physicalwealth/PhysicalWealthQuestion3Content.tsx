...
interface PhysicalWealthQuestion3ContentProps {
  answer: string;
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            <Text style={styles.questionText}>
              What behaviors or patterns does your best self refuse to tolerate because they undermine physical health and energy?
            </Text>
          </View>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Consider habits like poor sleep, unhealthy eating, skipping workouts, excessive stress, or neglecting recovery.
            </Text>
          </View>
        </ScrollView>
...
export default PhysicalWealthQuestion3Content;
