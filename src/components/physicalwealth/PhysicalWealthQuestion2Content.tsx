...
interface PhysicalWealthQuestion2ContentProps {
  answer: string;
        ...
        >
          ...
          <View style={styles.questionSection}>
            ...
            >
              <View style={styles.iconInnerCircle}>
                <Ionicons name="barbell" size={28} color="#059669" />
              </View>
            </LinearGradient>
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>
              Think about your workout routine, how you fuel your body, your sleep habits, and how you manage stress and recovery.
            </Text>
          </View>
        </ScrollView>
...
export default PhysicalWealthQuestion2Content;
