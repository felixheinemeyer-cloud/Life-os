...
interface FinancialWealthQuestion3ContentProps {
  answer: string;
...
const FinancialWealthQuestion3Content: React.FC<FinancialWealthQuestion3ContentProps> = ({
  answer,
  onAnswerChange,
  onContinue,
  buttonText = 'Continue',
...
export default FinancialWealthQuestion3Content;
