...
interface TimeWealthIntroAnimationScreenProps {
  navigation: {
    replace: (screen: string) => void;
  };
}

const TimeWealthIntroAnimationScreen: React.FC<TimeWealthIntroAnimationScreenProps> = ({
  navigation,
}) => {
  // Animation values
  ...
  useEffect(() => {
    ...
    const navigationTimer = setTimeout(() => {
      navigation.replace('TimeWealthIntro');
    }, 2400);
    ...
    <View style={styles.container}>
        <Animated.View style={[styles.content, { opacity: fadeIn }]}>
          ...
          <Animated.View style={[styles.labelContainer, { opacity: labelOpacity }]}>
            <Text style={styles.label}>TIME WEALTH</Text>
          </Animated.View>
            ...
            >
              ...
              >
                <View style={styles.iconCircleInner}>
                  <Ionicons name="time" size={56} color="#F59E0B" />
                </View>
              </LinearGradient>
            </Animated.View>
          </View>
          ...
          >
            <Text style={styles.caption}>
              Making every moment count in your life.
            </Text>
          </Animated.View>
        </Animated.View>
    </View>
...
export default TimeWealthIntroAnimationScreen;
