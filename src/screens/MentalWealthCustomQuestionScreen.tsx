...
interface MentalWealthCustomQuestionScreenProps {
  navigation: {
    goBack: () => void;
...
const MentalWealthCustomQuestionScreen: React.FC<MentalWealthCustomQuestionScreenProps> = ({
  navigation,
}) => {
...
export default MentalWealthCustomQuestionScreen;
