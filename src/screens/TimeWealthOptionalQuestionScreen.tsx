...
interface TimeWealthOptionalQuestionScreenProps {
  route: {
    params: {
      question: string;
...
const TimeWealthOptionalQuestionScreen = ({
  route,
  navigation,
}: TimeWealthOptionalQuestionScreenProps) => {
...
export default TimeWealthOptionalQuestionScreen;
