...
import FinancialWealthQuestion1Content from '../components/financialwealth/FinancialWealthQuestion1Content';
import FinancialWealthQuestion2Content from '../components/financialwealth/FinancialWealthQuestion2Content';
import FinancialWealthQuestion3Content from '../components/financialwealth/FinancialWealthQuestion3Content';
import FinancialWealthQuestion4Content from '../components/financialwealth/FinancialWealthQuestion4Content';

const { width: SCREEN_WIDTH } = Dimensions.get('window');
const TOTAL_STEPS = 4;

interface FinancialWealthQuestionsContainerScreenProps {
  navigation?: {
    goBack: () => void;
...
const FinancialWealthQuestionsContainerScreen: React.FC<FinancialWealthQuestionsContainerScreenProps> = ({
  navigation,
}) => {
  ...
  const handleContinue = () => {
    ...
    if (currentStep < TOTAL_STEPS - 1) {
      ...
      // Final step - complete the flow and go to Financial Wealth Overview
      console.log('Financial Wealth questions complete:', questionsData);
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.contentWrapper}>
          ...
          >
            {/* Step 1: Financial ideal life */}
            <View style={styles.page}>
              <FinancialWealthQuestion1Content
            ...
            {/* Step 2: Daily actions */}
            <View style={styles.page}>
              <FinancialWealthQuestion2Content
            ...
            {/* Step 3: Thinking and feeling about money */}
            <View style={styles.page}>
              <FinancialWealthQuestion3Content
            ...
            {/* Step 4: Long-term security and growth */}
            <View style={styles.page}>
              <FinancialWealthQuestion4Content
...
export default FinancialWealthQuestionsContainerScreen;
