...
import TimeWealthQuestion1Content from '../components/timewealth/TimeWealthQuestion1Content';
import TimeWealthQuestion2Content from '../components/timewealth/TimeWealthQuestion2Content';
import TimeWealthQuestion3Content from '../components/timewealth/TimeWealthQuestion3Content';
import TimeWealthQuestion4Content from '../components/timewealth/TimeWealthQuestion4Content';

const { width: SCREEN_WIDTH } = Dimensions.get('window');
const TOTAL_STEPS = 4;

interface TimeWealthQuestionsContainerScreenProps {
  navigation?: {
    goBack: () => void;
...
const TimeWealthQuestionsContainerScreen: React.FC<TimeWealthQuestionsContainerScreenProps> = ({
  navigation,
}) => {
  ...
  const handleContinue = () => {
    ...
    if (currentStep < TOTAL_STEPS - 1) {
      ...
      // Final step - complete the flow and go to Time Wealth Overview
      console.log('Time Wealth questions complete:', questionsData);
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.contentWrapper}>
          ...
          >
            {/* Step 1: Biggest priorities */}
            <View style={styles.page}>
              <TimeWealthQuestion1Content
            ...
            {/* Step 2: Time across seasons */}
            <View style={styles.page}>
              <TimeWealthQuestion2Content
            ...
            {/* Step 3: Typical day and week */}
            <View style={styles.page}>
              <TimeWealthQuestion3Content
            ...
            {/* Step 4: Regrets from age 80 */}
            <View style={styles.page}>
              <TimeWealthQuestion4Content
...
export default TimeWealthQuestionsContainerScreen;
