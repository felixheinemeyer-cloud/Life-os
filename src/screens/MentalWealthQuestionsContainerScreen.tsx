...
interface MentalWealthQuestionsContainerScreenProps {
  navigation?: {
    goBack: () => void;
...
const MentalWealthQuestionsContainerScreen: React.FC<MentalWealthQuestionsContainerScreenProps> = ({
  navigation,
}) => {
...
export default MentalWealthQuestionsContainerScreen;
