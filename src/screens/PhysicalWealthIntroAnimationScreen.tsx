...
interface PhysicalWealthIntroAnimationScreenProps {
  navigation: {
    replace: (screen: string) => void;
  };
}

const PhysicalWealthIntroAnimationScreen: React.FC<PhysicalWealthIntroAnimationScreenProps> = ({
  navigation,
}) => {
  // Animation values
      ...
      >
        <Animated.View style={[styles.content, { opacity: fadeIn }]}>
          ...
          <Animated.View style={[styles.labelContainer, { opacity: labelOpacity }]}>
            <Text style={styles.label}>PHYSICAL WEALTH</Text>
          </Animated.View>
            ...
            >
              ...
              >
                <View style={styles.iconCircleInner}>
                  <Ionicons name="fitness" size={56} color="#059669" />
                </View>
              </LinearGradient>
            </Animated.View>
          </View>
...
export default PhysicalWealthIntroAnimationScreen;
