...
interface TimeWealthCustomQuestionScreenProps {
  navigation: {
    goBack: () => void;
...
const TimeWealthCustomQuestionScreen: React.FC<TimeWealthCustomQuestionScreenProps> = ({
  navigation,
}) => {
...
export default TimeWealthCustomQuestionScreen;
