...
interface MentalWealthIntroAnimationScreenProps {
  navigation: {
    replace: (screen: string) => void;
  };
}

const MentalWealthIntroAnimationScreen: React.FC<MentalWealthIntroAnimationScreenProps> = ({
  navigation,
}) => {
  // Animation values
  ...
  useEffect(() => {
    ...
    const navigationTimer = setTimeout(() => {
      navigation.replace('MentalWealthIntro');
    }, 2400);
    ...
    <View style={styles.container}>
        <Animated.View style={[styles.content, { opacity: fadeIn }]}>
          ...
          <Animated.View style={[styles.labelContainer, { opacity: labelOpacity }]}>
            <Text style={styles.label}>MENTAL WEALTH</Text>
          </Animated.View>
            ...
            >
              ...
              >
                <View style={styles.iconCircleInner}>
                  <Ionicons name="bulb" size={56} color="#3B82F6" />
                </View>
              </LinearGradient>
            </Animated.View>
          </View>
          ...
          >
            <Text style={styles.caption}>
              Building the clearest version of you.
            </Text>
          </Animated.View>
        </Animated.View>
    </View>
...
export default MentalWealthIntroAnimationScreen;
