...
interface PhysicalWealthOptionalQuestionScreenProps {
  route: {
    params: {
      question: string;
...
const PhysicalWealthOptionalQuestionScreen = ({
  route,
  navigation,
}: PhysicalWealthOptionalQuestionScreenProps) => {
...
export default PhysicalWealthOptionalQuestionScreen;
