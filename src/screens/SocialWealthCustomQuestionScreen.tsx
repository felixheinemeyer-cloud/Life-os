...
interface SocialWealthCustomQuestionScreenProps {
  navigation: {
    goBack: () => void;
...
const SocialWealthCustomQuestionScreen: React.FC<SocialWealthCustomQuestionScreenProps> = ({
  navigation,
}) => {
...
export default SocialWealthCustomQuestionScreen;
